<section class="<?php echo html_escape(element('latest_class', element('config', $view))); ?>">
    <div class="m_list_tit">
        ...
        <a href="<?php echo group_url('g-a'); ?>" class="see_more" title="<?php echo html_escape(element('latest_title', element('config', $view))); ?>">더보기 <i class="fa fa-angle-right" style="font-size: 16px;vertical-align: middle;"></i></a>
    </div>
        <!-- Table -->
    <div class="">
        <ul class="list ">
