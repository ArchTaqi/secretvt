    ...
    <div class="mt20 mypage ">
        ...
        <section class="table_02">
            ...
            <div class="mypg_sub_cate">
                <ul class="cate_list">
                    <li class="cate_li active"><button type="button" class="btn" style="margin-bottom:0px" onClick="location.href='<?php echo site_url('mypage/followinglist'); ?>';">Following (<?php echo number_format(element('following_total_rows', $view)); ?>)</button></li>
                    <li class="cate_li"><button type="button" style="margin-bottom:0px" onClick="location.href='<?php echo site_url('mypage/followedlist'); ?>';" class="btn">Followed (<?php echo number_format(element('followed_total_rows', $view)); ?>)</button></li>
                </ul>
            </div>            
            <table class="">
                <thead>
