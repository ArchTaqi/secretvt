...
<div class="main_flex">
    ...
    <section class="title mt20">
            ...
            <h2 class="" style="color:#000;"><?php echo element('brd_name', element('board', element('list', $view))) ?> <?php echo element('post_title', element('post_parent',$view)) ?>
    ...
    <section class="title03">
        ...
        <h3>
            <a href="<?php echo element('write_url', element('list', $view)); ?>" class="btn-sm">글 쓰 기</a>
        </h3>
